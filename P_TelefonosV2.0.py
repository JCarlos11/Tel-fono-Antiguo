...
1.El audio sonará siempre que se levante el auricular y comenzará desde donde se colgó el auricular. 
Siempre que se cuelgue el auricular se detendrá el audio por completo
    ...
    try:
        while True:
            ...
            if GPIO.input(PinAur) == GPIO.LOW and not reproduciendo: 
                ...
                pygame.mixer.music.unpause() #Quita la pausa del audio para retomar donde se dejó
                print("3.SONAR AUDIO")
            ...
            if GPIO.input(PinAur) == GPIO.HIGH and pygame.mixer.music.get_busy(): 
                ...
                pygame.mixer.music.pause() #Se pausa el audio
                prev_s = current_s # Actualiza prev_s 
